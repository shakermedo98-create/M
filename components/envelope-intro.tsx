    ...
    <>
      ...
      >
        ...
        <div className="relative top-10 z-10 flex flex-col items-center">
          ...
          <span className="mt-25 inline-flex items-center gap-2 rounded-full border border-background/70 bg-background/20 px-7 py-3 text-xs uppercase tracking-[0.35em] text-background backdrop-blur-sm transition-colors group-hover:bg-background group-hover:text-ink">
            Tap to open
          </span>
